...
import { APIFailure, APIResponse, Errors } from "@/stores/types";
...
export async function loadResponseBodyOrReturnErrors<T>(
...
export async function ignoreResponseBodyOrReturnErrors(
  response: Response,
