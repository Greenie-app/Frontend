...
const en: VueI18n.LocaleMessageObject = {
  ...
  home: {
    jumbotron: {
      ...
      description: 'Greenie.app is a “greenie board” that records your pilots’ traps and bolters, '
    ...
    signUp: {
      ...
      help: 'Your entire squadron will share one login and password. Anyone can use that login and '
  ...
  logIn: {
    ...
    help: 'You only need to log in to add your passes or upload log files. Don’t know your '
  ...
  squadronBoard: {
    ...
    deleteAll: {
      ...
      title: 'Delete Passes',
      confirm: {
        message: 'This will permanently delete approx. {count} passes with unknown pilots. Continue?',
        okButton: 'Delete All'
      },
      error: {
  ...
  pilotBoard: {
    ...
    mergeConfirmModal: {
      title: 'Confirm Merge',
      message: 'Are you sure you want to merge {prey} into {predator}? All of {prey}’s passes will'
